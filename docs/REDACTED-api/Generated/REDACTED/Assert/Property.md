...
parent: Assert
has_children: False
permalink: /(REDACTED_FRAMEWORK)-api/(REDACTED).(REDACTED_OTHER_FRAMEWORK)/Assert/Property
---
# Assert.Property&lt;T&gt; method (1 of 2)
...
```csharp
public static AssertComparable<T, T> Property<T>(string propertyName, AssertType relation, 
    T limitValue, ProgramLocation program = ProgramLocation.GlobalProperties)
...
# Assert.Property&lt;T&gt; method (2 of 2)

Creates an action that asserts that the value of a property is as expected.

```csharp
public static AssertComparable<T, T> Property<T>(ProgramLocation program, 
