---
layout: default
title: BLEVectorElementWithNamedValue
grand_parent: 
parent: Assert
has_children: False
permalink: /(REDACTED_FRAMEWORK)-api/(REDACTED).(REDACTED_OTHER_FRAMEWORK)/Assert/BLEVectorElementWithNamedValue
---
# Assert.BLEVectorElementWithNamedValue&lt;T,T1&gt; method
...
```csharp
public static AssertBLEProperty<T, T1> BLEVectorElementWithNamedValue<T, T1>(
