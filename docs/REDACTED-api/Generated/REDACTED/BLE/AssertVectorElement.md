---
layout: default
title: AssertVectorElement
grand_parent: 
parent: BLE
has_children: False
permalink: /(REDACTED_FRAMEWORK)-api/(REDACTED).(REDACTED_OTHER_FRAMEWORK)/BLE/AssertVectorElement
---
# BLE.AssertVectorElement&lt;T&gt; method
...
```csharp
public static AssertBLEProperty<T, T> AssertVectorElement<T>(GNServiceMethods propertyName, 
